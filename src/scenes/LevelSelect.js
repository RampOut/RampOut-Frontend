...
export default class LevelSelect extends Phaser.Scene {
    ...
    create() {
        ...
        const btn_display1 = this.add.image(this.scale.width / 2, this.scale.height / 2, 'btn_display').setPosition(640, 275).setScale(0.6).setDepth(-5);
        const btn_display2 = this.add.image(this.scale.width / 2, this.scale.height / 2, 'btn_display').setPosition(640, 435).setScale(0.6).setDepth(-5);
                ...
                this.tweens.add({
                    ...
                    onComplete: () => {
                        this.tweens.add({
                            ...
                            ease: 'Power2',
                            onComplete: () => {
                                this.scene.start("LevelBuildYourCar"); // Cambia a tu escena del juego
                            }
                        });
                    }
                });
